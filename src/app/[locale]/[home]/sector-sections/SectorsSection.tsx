...
export default function SectorsSection() {
  ...
  return (
    <Section id="sectors" heightType="content" className="relative overflow-hidden py-0" fullWidth>
      ...
      <Container size="xlarge"className="relative z-10 py-16 md:py-24 h-full flex flex-col">
              ...
              {sectors.map(
                (sector) =>
                  activeIcon === sector.id && (
                    ...
                    >
                      <h4 className="font-semibold text-2xl mb-4 text-primary-100">{t("public.benefits.title")}</h4>
                      <ul className="space-y-4">
                        {sector.benefits.map((benefit, index) => (
                          ...
                          >
                            <CheckCircle className="h-7 w-7 text-primary-100 shrink-0 mt-0.5" />
