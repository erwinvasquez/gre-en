                    ...
                    <div className="bg-yellow-50 border border-yellow-200 p-3 rounded-lg">
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="font-semibold text-red-600">
                            {formatNumber(currentElectricityCost.costBs * 12)} Bs
                          </span>
                        </div>
                      </div>
                    </div>
                ...
                <Card className="h-fit">
                  <CardHeader>
                    <CardTitle className="flex items-center justify-between">
                      <div className="flex items-center">
                        ...
                        <span className="text-xl font-bold text-primary">Resultado de Cotización</span>
                      </div>
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    ...
                    <div className="bg-red-50 border border-red-200 p-4 rounded-lg">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="text-center">
                          <p className="text-muted-foreground mb-1">Gasto Mensual</p>
                        ...
                        <div className="text-center">
                          <p className="text-muted-foreground mb-1">Gasto Anual</p>
                          <p className="text-2xl font-bold text-red-600">
                    ...
                    <div className="text-center bg-primary/10 p-4 rounded-lg">
                      <h3 className="text-lg font-semibold mb-2">Inversión Generación Solar</h3>
                      ...
                      {results.systemCost?.transport > 0 && (
                        <p className="text-xs text-muted-foreground mt-1">
                          (Incluye transporte a {formData.department})
                        </p>
                      )}
                    </div>
                    ...
                    <div className="bg-green-50 border border-green-200 p-4 rounded-lg">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-3 gap-4">
                          <div className="text-center">
                            <p className="text-muted-foreground">Ahorro Anual Permitido (80%)</p>
                          ...
                          <div className="text-center">
                            <p className="text-muted-foreground">Tiempo de Retorno</p>
                            ...
                            <p className="text-xs text-muted-foreground mt-1">Para recuperar inversión</p>
                          </div>
                          <div className="text-center">
                            <p className="text-muted-foreground">Ahorro 25 años</p>
                            <p className="text-xl font-bold text-green-600">
                              {formatNumber(
                            ...
                            <p className="text-xs text-muted-foreground mt-1">Despues de la Inversion</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-green-50 border border-green-200 p-4 rounded-lg">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                        <div className="text-center">
                          <p className="text-muted-foreground mb-1">Equivalente a plantar</p>
                          <p className="text-2xl font-bold text-green-600">{formatNumber(treesEquivalent)}</p>
                          <p className="text-xs text-muted-foreground mt-1">árboles</p>
                        </div>
                        <div className="text-center">
                          <p className="text-muted-foreground mb-1">Equivalente a retirar</p>
                          <p className="text-2xl font-bold text-blue-600">{formatNumber(carsRemoved)}</p>
                          <p className="text-xs text-muted-foreground mt-1">autos de circulación</p>
                        </div>
                        <div className="text-center">
                          <p className="text-muted-foreground mb-1">Ahorro de</p>
                          <p className="text-2xl font-bold text-orange-600">{formatNumber(gasolineSaved)}</p>
                          <p className="text-xs text-muted-foreground mt-1">litros de gasolina</p>
                        </div>
                      </div>
                    </div>
                  </CardContent>
                ...
                <Card className="h-fit">
                  <CardContent className="p-8 text-center">
                    <div className="text-muted-foreground">
                      ...
                      <p className="text-sm">
                        Ingresa tus datos en el formulario de la izquierda para obtener tu cotización personalizada
                      </p>
                    </div>
                  </CardContent>
                </Card>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center">
                  ...
                  Estado de Costos del Sistema Solar
                </CardTitle>
                <p className="text-sm text-muted-foreground">
                  Desglose detallado de la inversión - Sistema de {formatNumber(results.totalPower)} kW
                </p>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <div className="bg-white border rounded-lg overflow-hidden">
                  <div className="bg-green-50 px-4 py-3 border-b">
                    <h4 className="font-semibold text-green-700">Costos de Instalación y Servicios</h4>
                  </div>
                  <div className="divide-y">
                    ...
                    <div className="px-4 py-2 hover:bg-slate-50">
                      <div className="grid grid-cols-12 gap-4 text-sm">
                        ...
                        <div className="col-span-7">
                          <div className="font-medium">Transporte a {formData.department}</div>
                          <div className="text-xs text-muted-foreground">
                  ...
                  <div className="bg-green-50 px-4 py-3 border-t">
                    <div className="grid grid-cols-12 gap-4 text-sm">
                      <div className="col-span-8"></div>
                      <div className="col-span-2 text-right font-semibold">Subtotal Instalación:</div>
                ...
                <div className="bg-white border rounded-lg overflow-hidden">
                  <div className="bg-slate-50 px-4 py-3 border-b">
                    <h4 className="font-semibold text-slate-700">Ajustes y Costos Administrativos</h4>
                  </div>
                  <div className="divide-y">
                    {/* Ajuste por Sector */}
                        ...
                        <div className="grid grid-cols-12 gap-4 text-sm">
                          ...
                          <div className="col-span-7">
                            <div className="font-medium">
                              Ajuste Sector {SECTORS.find((s) => s.id === formData.sector)?.name}
                            </div>
                            <div className="text-xs text-muted-foreground">
                              Multiplicador: {results.technicalDetails?.sectorMultiplier?.toFixed(2)}x
                            </div>
                          </div>
                    ...
                    <div className="px-4 py-2 hover:bg-slate-50">
                      <div className="grid grid-cols-12 gap-4 text-sm">
                        ...
                        <div className="col-span-7 font-medium">Utilidad Empresarial (40%)</div>
                        <div className="col-span-2 text-center">-</div>
                        <div className="col-span-2 text-right font-medium">
                    ...
                    <div className="px-4 py-2 hover:bg-slate-50">
                      <div className="grid grid-cols-12 gap-4 text-sm">
                        ...
                        <div className="col-span-7 font-medium">Comisión de Ventas (3%)</div>
                        <div className="col-span-2 text-center">-</div>
                        <div className="col-span-2 text-right font-medium">
                    ...
                    <div className="px-4 py-2 hover:bg-slate-50">
                      <div className="grid grid-cols-12 gap-4 text-sm">
                        ...
                        <div className="col-span-7 font-medium">Impuesto a las Transacciones (3%)</div>
                        <div className="col-span-2 text-center">-</div>
                        <div className="col-span-2 text-right font-medium">
                    ...
                    <div className="px-4 py-2 hover:bg-slate-50">
                      <div className="grid grid-cols-12 gap-4 text-sm">
                        ...
                        <div className="col-span-7 font-medium">IVA (13%)</div>
                        <div className="col-span-2 text-center">-</div>
                        <div className="col-span-2 text-right font-medium">
                  ...
                  <div className="bg-slate-50 px-4 py-3 border-t">
                    <div className="grid grid-cols-12 gap-4 text-sm">
                      <div className="col-span-8"></div>
                      <div className="col-span-2 text-right font-semibold">Subtotal Ajustes:</div>
                  ...
                  <div className="px-6 py-4">
                    <div className="grid grid-cols-12 gap-4">
                      <div className="col-span-8">
                        <div className="text-lg font-bold text-primary">TOTAL INVERSIÓN SISTEMA SOLAR</div>
                        <div className="text-sm text-muted-foreground">Sistema completo instalado y funcionando</div>
                      </div>
                      <div className="col-span-4 text-right">
                        ...
                        <div className="text-xs text-muted-foreground">
                          Tipo de cambio: {results.technicalDetails?.exchangeRate} Bs/USD
                        </div>
                      </div>
                    </div>
                  </div>
